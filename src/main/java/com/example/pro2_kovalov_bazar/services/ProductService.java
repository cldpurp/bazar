...
import com.example.pro2_kovalov_bazar.repositories.ProductRepository;
...
public class ProductService {
    ...
    public void saveProduct(Principal principal,
        ...
        log.info("Saving new Product. Title: {}; Author's email: {}", product.getTitle(), product.getUser().getEmail());
